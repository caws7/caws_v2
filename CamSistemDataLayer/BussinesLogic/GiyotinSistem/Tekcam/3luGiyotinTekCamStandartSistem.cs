...
{
    public static class _3luGiyotinTekCamStandartSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-120":
                        ...
                        break;
                    case "G-121":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 175.968) / 3) - 1.769 - 3.3) + 13.38 + 11.376);
                    ...
                    case "G-121-2"://orta cam
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 175.968) / 3) + 0.849 - 3.3) + 13.38 + 11.376);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-121-3"://alt cam
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 175.968) / 3) + 0.92 - 3.3) + 13.38 + 11.377);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-122":
                    ...
                    case "G-124":
                        ...
                        break;
                    case "G-126":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 175.968) / 3) - 1.769 - 3.3) - 16.594 + 15.277);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-126-1":
                        ...
                        break;
                    case "G-126-2":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 175.968) / 3) - 1.769 - 3.3) + (((double)(boy - 175.968) / 3) + 0.849 - 3.3) + 0.386 + 12.227) - 13.594);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 175.968) / 3 - 1.769 - 3.3);
            ...
            camModel.Genislik = en - 185;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 175.968) / 3 + 0.849 - 3.3);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
            ...
            camModel.Genislik = en - 185;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 175.968) / 3 + 0.92 - 3.3);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
