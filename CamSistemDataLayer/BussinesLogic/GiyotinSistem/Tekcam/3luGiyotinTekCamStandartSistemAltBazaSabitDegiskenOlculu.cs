...
{
    public static class _3luGiyotinTekCamStandartSistemAltBazaSabitDegiskenOlculu
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-120":
                        ...
                        break;
                    case "G-121":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 172.253) - 900) / 2 - 5)+24);
                    ...
                    case "G-125":
                        ...
                        break;
                    case "G-126":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 172.253) - 900) / 2 - 5) + 169.98 - 145);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-126-1":
                        ...
                        break;
                    case "G-126-2":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 172.253) - 900) / 2 - 5) + 47.16 + (((double)(boy - 172.253) - 900) / 2 - 5) + 169.98)-145);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32(((double)(boy - 172.253) - 900) / 2 - 5);
