...
{
    class _2liGiyotinTekCamGenisSeriVasistasliSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-129":
                        ...
                        break;
                    case "G-127":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 267.128) / 2) + 29.864 - 5) + (14 + 20));
                    ...
                    case "G-107":
                        ...
                        break;
                    case "G-108":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 267.128) / 2 + 29.864 - 5) + 20.427) - 25.342);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-109":
                    ...
                    case "G-111-1":
                        ...
                        break;
                    case "G-111-2":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 267.128) / 2) - 29.864 - 5) + (62.7258 * 2));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-112":
                    ...
                    case "G-112-1":
                        ...
                        break;
                    case "G-112-2":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 267.128) / 2) - 29.864 - 5) + (62.7258 * 2)) - 39);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-113":
                    ...
                    case "G-116-1"://yatay
                        ...
                        break;
                    case "G-116-2"://dikey
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 267.128) / 2) - 29.864 - 5) + (62.7258 * 2)) - 39 - 85); ;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 267.128) / 2 + 29.864 - 5);
