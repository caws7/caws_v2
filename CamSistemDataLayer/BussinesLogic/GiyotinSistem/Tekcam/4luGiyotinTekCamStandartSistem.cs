...
{
    public static class _4luGiyotinTekCamStandartSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-120":
                        ...
                        break;
                    case "G-121":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 170.242) / 4) - 1.984 - 2.5) + 24;
                        item.KesimAdet = adet;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-121-1"://dikey baza üst cam
                        ...
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-121-2"://orta cam
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 170.242) / 4) + 0.634 - 2.5) + 24);
                        item.KesimAdet = adet * 4;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-121-3"://alt cam
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 170.242) / 4) + 0.716 - 2.5) + 24);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-122":
                    ...
                    case "G-124":
                        ...
                        break;
                    case "G-126":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 170.242) / 4) - 1.984 - 2.5) - 1.264);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-126-1":
                        ...
                        break;
                    case "G-126-2":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 170.242) / 4) - 1.984 - 2.5) + (((double)(boy - 170.242) / 4) + 0.634 - 2.5) - 3);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 170.242) / 4 - 1.984 - 2.5);
            ...
            camModel.Adet = adet;
            camModel.CamAdi = "ORTA CAM1";
            camModel.Genislik = en - 172;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 170.242) / 4 + 0.634 - 2.5);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);

            camModel = new CamBilgileri();
            camModel.Adet = adet;
            camModel.CamAdi = "ORTA CAM2";
            camModel.Genislik = en - 172;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 170.242) / 4 + 0.634 - 2.5);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
            ...
            camModel.Genislik = en - 172;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 170.242) / 4 + 0.716 - 2.5);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
