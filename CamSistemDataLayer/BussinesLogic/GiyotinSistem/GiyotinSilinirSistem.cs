...
{
    public static class GiyotinSilinirSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "T-2492":
                        ...
                        break;
                    case "T-2457-1":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 207 + 11) / 3) - 3) + 32 + 3;
                    ...
                    case "T-2499":
                        ...
                        break;
                    case "T-2452":
                        item.KesimOlcusu = boy - 173 - Convert.ToInt32(((double)(boy - 207 + 11) / 3) - 3 + 28 + 3) - 6;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "T-2494":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 207 + 11) / 3) - 3) + 28 + 3;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "T-2451":
                        ...
                        break;
                    case "T-2456-1":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 207 + 11) / 3) - 3 + 31 - 31.7) + 3 + 2;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "T-2456-2":
                        ...
                        break;
                    case "T-2493":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 207 + 11) / 3) - 3 + 28.7) + 3;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "T-2491":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 207 + 11) / 3 - 3);
