...
{
    public static class _3luGiyotinIsicamliVasistasliSilinirSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-104":
                        ...
                        break;
                    case "G-106":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 292.508) / 3) + 37.333 - 3.3) + (14 + 20));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    ...
                    case "G-106-2"://orta cam
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 292.508) / 3) + 22.983 - 3.3) + (23.021 + 19.8));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-107":
                    ...
                    case "G-108":
                        ...
                        break;
                    case "G-109":
                        item.KesimOlcusu = Convert.ToInt32(boy - ((((double)(boy - 292.508) / 3 - 60.316 - 3.3) + (68.416 * 2)) + 147));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-110":
                    ...
                    case "G-110-1":
                        ...
                        break;
                    case "G-110-2":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 292.508) / 3) + 37.333 - 3.3) + 3.985);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-111":
                    ...
                    case "G-111-1":
                        ...
                        break;
                    case "G-111-2":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 292.508) / 3) - 60.316 - 3.3) + (68.416 * 2));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-112":
                    ...
                    case "G-112-1":
                        ...
                        break;
                    case "G-112-2":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 292.508) / 3) - 60.316 - 3.3) + (68.416 * 2)) - 39);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-113":
                    ...
                    case "G-115-1":
                        ...
                        break;
                    case "G-115-2":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 292.508) / 3) - 60.316 - 3.3) + (68.416 * 2)) - 39 - 85); ;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 292.508) / 3 + 37.333 - 3.3);
            ...
            camModel.Genislik = en - 172 - 5;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 292.508) / 3 + 22.983 - 3.3);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 292.508) / 3 - 60.316 - 3.3);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
