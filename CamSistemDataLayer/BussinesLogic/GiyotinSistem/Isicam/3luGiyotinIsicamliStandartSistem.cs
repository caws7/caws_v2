...
{
    public static class _3luGiyotinIsicamStandartSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-105":
                        ...
                        break;
                    case "G-106":
                        item.KesimOlcusu = Convert.ToInt32((double)(boy - 183.07) / 3 + 5.86 - 3.3) + (14 + 20);
                    ...
                    case "G-106-2"://orta cam
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 183.07) / 3 - 2.929 - 3.3) + (19.98 + 21.98));
                        item.KesimAdet = adet * 4;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-107":
                    ...
                    case "G-109":
                        ...
                        break;
                    case "G-110":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 183.07) / 3 + 5.86 - 3.3) + ((double)(boy - 183.07) / 3 - 2.929 - 3.3) - 3.45 - 28.43) + 19.407);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "G-110-1":
                        ...
                        break;
                    case "G-110-2":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 183.07) / 3 + 5.86 - 3.3) - 27.43) + 19.407);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (item.BirimAgirlik ?? 0));
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 183.07) / 3 + 5.86 - 3.3);
            ...
            camModel.Genislik = en - 172 - 5;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 183.07) / 3 - 2.929 - 3.3);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
