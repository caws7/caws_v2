...
{
    public static class _2liGiyotinIsicamliStandartSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-105":
                        ...
                        break;
                    case "G-106":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 188.405) / 2) + 3.865 - 5) + (14 + 20));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    ...
                    case "G-106-3"://sabit cam
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 188.405) / 2) - 3.865 - 5) + (22 + 20));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-107":
                    ...
                    case "G-109":
                        ...
                        break;
                    case "G-110":
                        item.KesimOlcusu = Convert.ToInt32((((double)(boy - 188.405) / 2) + 3.865 - 5 + 21.407) - 26.53);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-110-1":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 188.405) / 2 + 3.865 - 5);
