...
{
    public static class _4luGiyotinIsicamliStandartSistem
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-105":
                        ...
                        break;
                    case "G-106":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 180.75) / 4) + 5.938) + (14 + 20);
                    ...
                    case "G-106-2"://orta cam
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 180.75) / 4) - 2.062 + (26.285 + 20));
                        item.KesimAdet = adet * 6;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-107":
                    ...
                    case "G-109":
                        ...
                        break;
                    case "G-110":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 180.75) / 4) + 5.938) + 169.98) - 150);
                    ...
                    case "G-110-1":
                        ...
                        break;
                    case "G-110-2":
                        item.KesimOlcusu = Convert.ToInt32(((((double)(boy - 180.75) / 4) + 5.938) + 47.16 + (((double)(boy - 180.75) / 4) + 5.938) + 169.98) - 150);
                        item.KesimAdet = adet * 4;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "SB-101":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 180.75) / 4 + 5.938);
            ...
            camModel.CamAdi = "DİĞER CAM";
            camModel.Genislik = en - 160;
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 180.75) / 4 - 2.062);
            camModel.Alanm2 = (double)camModel.Yukseklik * camModel.Adet * camModel.Genislik / 1000000;
            camEntityList.Add(camModel);
