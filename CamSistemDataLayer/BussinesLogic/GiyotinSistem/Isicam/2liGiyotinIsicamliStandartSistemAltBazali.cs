...
{
    public static class _2liGiyotinIsicamliStandartSistemAltBazali
    {
            ...
            foreach (Profil item in profilList)
            {
                switch (item.ProfilKodu)
                {
                    ...
                    case "G-105":
                        ...
                        break;
                    case "G-106":
                        item.KesimOlcusu = Convert.ToInt32((double)(boy - 198.88) / 2 + 2.197 - 5 + (14 + 20));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    ...
                    case "G-106-3"://Sabit Cam
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 198.88) / 2) - 2.197 - 5 + (22 + 20));
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-107":
                    ...
                    case "G-108":
                        ...
                        break;
                    case "G-109":
                        item.KesimOlcusu = boy - 148;
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-110":
                        item.KesimOlcusu = Convert.ToInt32(((double)(boy - 198.88) / 2 + 2.197 - 5) + 21.407 - 28.43);
                        item.KesimAdet = adet * 2;
                        item.ToplamAgirlik = profilToplamAgirlikHesaplama(item.KesimOlcusu, item.KesimAdet, (int)item.BirimAgirlik);
                        break;
                    case "G-111":
        ...
        public static List<CamBilgileri> CamYukseklikHesapla(int boy, int en, int adet)
        {
            ...
            camModel.Yukseklik = Convert.ToInt32((double)(boy - 198.88) / 2 + 2.197 - 5);
